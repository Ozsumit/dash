...
const ReactQuill = dynamic(() => import("react-quill-new"), {
  ssr: false,
  // Custom loading skeleton using standard tailwind classes
  loading: () => <div className="h-[200px] w-full rounded-md bg-gray-100 animate-pulse" />,
})
    ...
    <div className="space-y-8 p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage your school photo albums and media library.</p>
        </div>
        <Dialog open={dialogOpen} onOpenChange={(open) => {
          ...
          <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Add details for your gallery item. All fields are editable later.
              </DialogDescription>
            </DialogHeader>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {filteredImages.map((image) => (
            <Card key={image.id} className="overflow-hidden group border-none shadow-sm hover:shadow-lg transition-all duration-300">
              ...
              <CardFooter className="p-4 bg-card border-t flex flex-col items-start gap-1">
                <h3 className="font-semibold truncate w-full" title={image.title}>{image.title}</h3>
